...
<img src='https://media.giphy.com/media/jWDBIfJseJ75807Eob/giphy.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes
The Fragments seemed similar to components in Web development, so I was able to follow along with the concept, The implementation of the features was a little more complicated, mainly since we had to split each component to the different fragment views. The videos was very clear in how to implement this hard part though, but I feel like it would be hard to do on my own.
