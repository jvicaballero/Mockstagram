...
import com.example.mockstagram.LoginActivity;
...
public class ComposeFragment extends Fragment {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(description.isEmpty()) {
                    Toast.makeText(getContext(), "Description cant be empty" , Toast.LENGTH_SHORT);
                    return;
                }
    ...
    //Uniform resource identifier, string that unambiguously identifies a resource file.
